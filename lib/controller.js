...
var FileUploaderController = function (dataform, processArgFunc, options) {
  ...
  dataform.app.post.apply(dataform.app, processArgFunc(dataform.options, ['file/upload/:model', function (req, res) {
  ...
  dataform.app.get.apply(dataform.app, processArgFunc(dataform.options, ['file/:model/:id', function (req, res) {
    try {
      var mongo = dataform.mongoose.mongo;
      var model = req.params.model;
      var resource = dataform.getResource(model);
  ...
  // Thumbnails endpoint
  dataform.app.get.apply(dataform.app, processArgFunc(dataform.options, ['file/:model/thumbnail/:id', function (req, res) {
    try {
      var mongo = dataform.mongoose.mongo;
      var model = req.params.model;
      var resource = dataform.getResource(model);
  ...
  dataform.app.delete.apply(dataform.app, processArgFunc(dataform.options, ['file/:model/:id', function (req, res) {
    var mongo = dataform.mongoose.mongo;
    var model = req.params.model;
    var resource = dataform.getResource(model);
