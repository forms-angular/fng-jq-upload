...
export function controller(fng, processArgs, options) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            items = (_b = req.body) === null || _b === void 0 ? void 0 : _b.files;
                            if (!Array.isArray(items)) {
                                res.status(400).send({ error: "Request body must include a 'files' array" });
                                return [2 /*return*/];
                            }
                            return [4 /*yield*/, options.presignBatchDelegate(req, req.params.model, items)];
                        case 1:
                            result = _c.sent();
                        ...
                        case 2:
                            e_2 = _c.sent();
                            res.status(500).send({ error: e_2.message || "An unexpected error occurred" });
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
                });
    ...
    fng.app.delete.apply(fng.app, processArgs(modifiedFngOpts, [
        ...
        function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var location_3, fileId, mongo, model, resource, gridFSBucket, thumbnailId, collection, obj, _b, e_3;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            if (!(location_3 === StoreInMongoDB)) return [3 /*break*/, 8];
                            mongo = fng.mongoose.mongo;
                            ...
                            thumbnailId = req.query.thumbnailId;
                            if (!!thumbnailId) return [3 /*break*/, 4];
                            collection = fng.mongoose.connection.collection(resource.model.collection.name + ".files");
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, collection.findOne({ "metadata.original_id": fileId }, {})];
                        case 2:
                            obj = _c.sent();
                            if (obj) {
                        ...
                        case 3:
                            _b = _c.sent();
                            return [3 /*break*/, 4];
                        case 4: return [4 /*yield*/, gridFSBucket.delete(new mongo.ObjectId(fileId))];
                        case 5:
                            _c.sent();
                            if (!thumbnailId) return [3 /*break*/, 7];
                            return [4 /*yield*/, gridFSBucket.delete(new mongo.ObjectId(thumbnailId))];
                        case 6:
                            _c.sent();
                            _c.label = 7;
