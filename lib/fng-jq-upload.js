    ...
    fng.app.post.apply(fng.app, processArgs(modifiedFngOpts, [
        ...
        function (req, res) {
            ...
            storageLimitsPromise.then(function (storageLimits) {
                ...
                var filePromises = [];
                busboy.on("file", function (internalFieldname, file, filename) {
                    var _b;
                    ...
                    filePromises.push((((_b = options.storageDelegate) === null || _b === void 0 ? void 0 : _b.call(options, req, fieldName, file, filename, resource, schemaThumbnailOpts)) ||
                        storeInMongoDB(fng, resource, file, filename, schemaThumbnailOpts)) // we need to catch here rather than waiting for the promise.all(..) call that we make in the busboy.on("finish")
