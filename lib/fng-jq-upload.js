        ...
        function (req, res) {
            ...
            storageLimitsPromise.then(function (storageLimits) {
                ...
                busboy.on("file", function (internalFieldname, file, filename) {
                    ...
                    var promise = ((_b = options.storageDelegate) === null || _b === void 0 ? void 0 : _b.call(options, req, fieldName, file, filename, resource, schemaThumbnailOpts)) ||
                ...
                busboy.on("finish", function () {
                    return Promise.all(filePromises)
                        ...
                        if (exports.TOO_LARGE_FLAG in e) {
                            ...
                            msg = "The file is too large.  The maximum permitted size is ".concat(value, " ").concat(units, ".");
                        }
                        else {
...
//# sourceMappingURL=fng-jq-upload.js.map