...
function Controller(fng, processArgs, options) {
    ...
    fng.app.get.apply(fng.app, processArgs(modifiedOptions, ['file/:model/thumbnail/:id', function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var mongo, model, resource, id, idObj, files, cursor, thumbnailData, gridFSBucket, readstream, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            gridFSBucket = new mongo.GridFSBucket(fng.mongoose.connection.db, { bucketName: resource.model.collection.name });
